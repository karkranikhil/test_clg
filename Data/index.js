export default {
  ...
  HEADER_DATA: {
    ...
    profile_links: [
      {
        type: "Linkedin",
        text: "linkedin.com/in/nikhilkarkra",
    ...
    AWARDS_LIST: [
      {
        NAME: "Microsoft MVP",
        DESCRIPTION:
          "Award description goes here, sem. Nulla consequat massa quis enim. Donec pede justo.",
      },
      {
  ...
  INTERESTS_DATA: {
    HEADING: "Interests",
    INTERESTS_LIST: ["Reading", "Cooking", "Cricket"],
  },
}
